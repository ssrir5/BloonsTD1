...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../bloonstd1_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is bloonstd1_soc
SOPC_NAME := bloonstd1_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x230
SOPC_SYSID_FLAG += --sidp=0x230
ELF_PATCH_FLAG  += --sidp 0x230

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1682647971
SOPC_SYSID_FLAG += --timestamp=1682647971
ELF_PATCH_FLAG  += --timestamp 1682647971
